...
echo "========================================================"
echo "   FIX LỖI BIẾN CART TRONG CHECKOUT PAGE"
echo "========================================================"

# Cập nhật checkout/page.tsx với biến đúng (items: cart)
...
export default function CheckoutPage() {
  ...
  // FIX: Lấy 'items' từ context và đổi tên thành 'cart' để khớp logic cũ
