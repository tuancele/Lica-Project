...
echo "🛠️ Đang sửa lỗi Type Error trong Product List..."

# Ghi đè file apps/admin/app/products/page.tsx với bản sửa lỗi ép kiểu Number()
              ...
              data.data.map((p) => (
                <tr key={p.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 font-medium text-green-600">
                    {/* FIX: Thêm Number() để ép kiểu tránh lỗi TypeScript */}
